...
program.command('setup').action(async () => {
  ...
  const verifiableCredential = await wallet.createCredential(product.did, credential, name, documentLoader);

  console.log('\nProduct Verifiable Credential created: ', verifiableCredential);
